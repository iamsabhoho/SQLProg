...
SELECT album_name FROM album WHERE album_name LIKE "l%" OR (album_name LIKE "s%" AND album.album_name LIKE "%g");

#Exercises
SELECT album_name FROM album WHERE album_name LIKE "l%" OR album_name LIKE "s%" OR album.album_name LIKE "p%"; #1
SELECT album_name FROM album WHERE (album_name LIKE "l%" OR album_name LIKE "s%") AND album.album_name LIKE "%g"; #2
SELECT * FROM album WHERE album_id != 1 AND album.album_id != 3; #3
SELECT * FROM album WHERE album_id > 2 AND (album.album_id != 4 AND album.album_id != 6); #4
SELECT * FROM album WHERE album_name NOT LIKE "L%"; #5
SELECT * FROM album WHERE album_name LIKE "s%" AND album.album_name NOT LIKE "%)"; #6
SELECT artist_name FROM artist WHERE artist_name LIKE "%es" XOR artist.artist_name LIKE "the%"; #7
SELECT artist_id FROM album WHERE album_name = "Brotherhood"; #8 sth here

#Exercises
SELECT track_name FROM track WHERE time < 5 LIMIT 3; #1
SELECT time, track_name, artist_id FROM track ORDER BY time DESC, track_name DESC LIMIT 5; #2
